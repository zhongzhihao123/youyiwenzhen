...
const saveIllnessType = (type: 0 | 1) => {
  store.setIllnessType(type)
}
</script>
...
<template>
  <div class="consult-fast-page">
    ...
    <div class="fast-type">
      <router-link @click="saveIllnessType(1)" to="/consult/dep" class="item">
      ...
      <router-link @click="saveIllnessType(0)" to="/consult/dep" class="item">
